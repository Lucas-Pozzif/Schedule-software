...
export function ReturnButton(parameters) {

    const colorClass =  parameters.lightMode?'icon-color-light':'icon-color-dark'

    return (
        <div>
            <svg className={`return-button-icon ${colorClass}`} viewBox="0 0 142 142">
